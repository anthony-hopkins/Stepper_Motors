...
class Stepper:
    ...
    def rotate_clockwise_degree(self, motor_pins, sequence, sequence_speed=.001, degrees=90):
        ...
        try:
            ...
            while current_degree <= degrees:
                ...
                for pin in range(0, 4):
                    xpin = motor_pins[pin]
                    if sequence[self.advanced_step_counter][pin] != 0:
    ...
    def rotate_counter_clockwise_degree(self, motor_pins, sequence, sequence_speed=.001, degrees=90):
        self.init_pins(motor_pins)
        sequence_steps = len(sequence)
        sequence_counter = 0
        degree_per_step = 0.087890625
